...
<center>
	...
	<h1><b>...Welcome to the Rgistered User Details Page...</b></h1>
	<br>
	...
	<?php
		...
		if($result->num_rows>0){
			while($row=$result->fetch_assoc()){
				...
				<td>".$row["Otherimg"]."</td>
				<td>
				<button style='background-color:lime;'> <a href='approve.php? approveid=$row[ID]'>Approve</a></button>
				<button style='background-color:red;'> <a href='reject.php? rejectid=$row[ID]'>Reject</a></button>
				</td>
				</tr>";
			}
		}
